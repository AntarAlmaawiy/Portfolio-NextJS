    ...
    return (
        <div className="pb-20 pt-36 ">
            <div>
                ...
                <Spotlight className="-top-10 -left-full h-[80vh] w-[50hv]" fill="purple"/>
                <Spotlight className="top-28 left-80 h-[80vh] w-[50hv]" fill="blue"/>
            </div>
            ...
            <div className="flex justify-center relative my-20 z-10 ">
                <div className="max-w-[80vw] md:max-w-2x; lg:max-w-[60vw] flex flex-col items-center justify-center">
...
"
                    ...
                    <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
                        Hi I&apos;am Antar, A full stack developer
                    </p>
                <a href="#about">
                    <MagicButton
                        title="Show my work"
